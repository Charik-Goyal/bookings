...
func main() {
	...
	// ###########################################
	// Example of how go library sends the data but will use go-simple-mail
	// from := "me@here.com"
...
func run() (*driver.DB, error) {
	...
	db, err := driver.ConnectSQL("host=localhost port=5432 dbname=bookings user=postgres password=charik123")
	if err != nil {
	...
	if err != nil {
		log.Fatal("Cannot create template cache because -> ", err)
		return nil, err
	}
